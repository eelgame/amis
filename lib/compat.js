...
var File_1 = require("./renderers/Form/File");
var Image_1 = require("./renderers/Form/Image");
var RichText_1 = require("./renderers/Form/RichText");
...
factory_1.addSchemaFilter(function (scheam, renderer) {
    ...
    if (scheam.reciever) {
        scheam = tslib_1.__assign(tslib_1.__assign({}, scheam), { receiver: scheam.reciever });
        delete scheam.reciever;
    }
    if (scheam.videoReciever) {
        scheam = tslib_1.__assign(tslib_1.__assign({}, scheam), { videoReceiver: scheam.reciever });
        delete scheam.reciever;
    }
    return scheam;
});
