...
var Switch = /** @class */ (function (_super) {
    ...
    Switch.prototype.render = function () {
        ...
        return (react_1.default.createElement("label", { className: cx("Switch", isChecked ? 'is-checked' : '', disabled ? 'is-disabled' : '', className) },
            react_1.default.createElement("input", tslib_1.__assign({ type: "checkbox", checked: isChecked, onChange: this.hanldeCheck, disabled: disabled, readOnly: readOnly }, rest)),
