...
var AnchorNavSectionComponent = /** @class */ (function (_super) {
    tslib_1.__extends(AnchorNavSectionComponent, _super);
...
var AnchorNav = /** @class */ (function (_super) {
    ...
    AnchorNav.prototype.scrollToSection = function (key) {
        // 获取指定段落的offsettop
        var offsetArr = this.state.offsetArr;
        var section = lodash_1.find(offsetArr, function (item) { return item.key === key; });
        var sectionRootDom = this.contentDom && this.contentDom.current;
        // 滚动到指定段落
        section &&
    ...
    AnchorNav.prototype.renderSection = function (section, index) {
        ...
        var active = activeProp === undefined && index === 0 ? name : activeProp;
        return react_1.default.cloneElement(section, tslib_1.__assign(tslib_1.__assign({}, section.props), { key: index, classnames: classnames,
            active: active }));
    };
...
var ThemedAnchorNav = theme_1.themeable(uncontrollable_1.uncontrollable(AnchorNav, {
    active: 'onSelect'
}));
