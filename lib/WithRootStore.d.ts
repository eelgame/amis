...
export declare function withRootStore<T extends React.ComponentType<React.ComponentProps<T> & {
    ...
    new (props: JSX.LibraryManagedAttributes<T, Pick<React.ComponentProps<T>, Exclude<keyof React.ComponentProps<T>, "rootStore">>> | Readonly<JSX.LibraryManagedAttributes<T, Pick<React.ComponentProps<T>, Exclude<keyof React.ComponentProps<T>, "rootStore">>>>): {
        render(): JSX.Element;
        context: any;
