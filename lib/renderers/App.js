...
var Layout_1 = tslib_1.__importDefault(require("../components/Layout"));
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!api_1.isEffectiveApi(api, store.data)) return [3 /*break*/, 2];
...
var AppRenderer = /** @class */ (function (_super) {
    tslib_1.__extends(AppRenderer, _super);
    function AppRenderer() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    AppRenderer.prototype.componentWillMount = function () {
