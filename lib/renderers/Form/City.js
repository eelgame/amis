...
var CityPicker = /** @class */ (function (_super) {
    ...
    CityPicker.prototype.render = function () {
        ...
        return db ? (react_1.default.createElement("div", { className: cx('CityPicker', className) },
            ...
            cityCode &&
                allowDistrict && ((_b = (_a = db.district[provinceCode]) === null || _a === void 0 ? void 0 : _a[cityCode]) === null || _b === void 0 ? void 0 : _b.length) ? (react_1.default.createElement(components_1.Select, { searchable: searchable, disabled: disabled, options: db.district[provinceCode][cityCode].map(function (item) { return ({
                    label: db[item],
                    value: item
