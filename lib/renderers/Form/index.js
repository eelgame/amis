...
var Form = /** @class */ (function (_super) {
    ...
    Form.prototype.componentDidMount = function () {
        ...
        this.mounted = true;
        if (onValidate) {
            var finalValidate_1 = helper_1.promisify(onValidate);
        ...
        if (Array.isArray(rules) && rules.length) {
            this.disposeRulesValidate = this.addHook(function () {
                ...
                rules.forEach(function (item) {
                    return !tpl_1.evalExpression(item.rule, store.data) &&
                        ...
                        return tslib_1.__generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    if (!(feedback && helper_1.isVisible(feedback, store.data))) return [3 /*break*/, 2];
