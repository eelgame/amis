...
var ComboControl = /** @class */ (function (_super) {
    ...
    ComboControl.prototype.componentWillMount = function () {
        var _a = this.props, store = _a.store, value = _a.value, multiple = _a.multiple, minLength = _a.minLength, maxLength = _a.maxLength, formItem = _a.formItem, addHook = _a.addHook;
        store.config({
            multiple: multiple,
            minLength: minLength,
            maxLength: maxLength,
    ...
    ComboControl.prototype.componentWillReceiveProps = function (nextProps) {
        ...
        if (helper_1.anyChanged(['minLength', 'maxLength', 'value'], props, nextProps)) {
            var store = nextProps.store, minLength = nextProps.minLength, maxLength = nextProps.maxLength, multiple = nextProps.multiple;
    ...
    ComboControl.prototype.pickCondition = function (value) {
        ...
        return find_1.default(conditions, function (item) { return item.test && helper_2.evalExpression(item.test, value); });
    };
    ...
    ComboControl.prototype.renderTabsMode = function () {
        ...
        return (react_1.default.createElement(Tabs_1.default, { className: 'ComboTabs', mode: tabsStyle, activeKey: store.activeKey, onSelect: this.handleTabSelect, additionBtns: !disabled ? (react_1.default.createElement("li", { className: cx("Tabs-link ComboTabs-addLink") }, store.addable && addable !== false ? (Array.isArray(conditions) && conditions.length ? (render('add-button', {
            ...
            if (finnalRemovable && // 表达式判断单条是否可删除
                (!itemRemovableOn ||
                    helper_2.evalExpression(itemRemovableOn, value) !== false)) {
            ...
            return (react_1.default.createElement(Tabs_1.Tab, { title: tpl_1.filter(tabsLabelTpl ||
                    __('{{index}}', { index: data.index + 1 }), data), key: _this.keys[index] || (_this.keys[index] = helper_1.guid()), toolbar: toolbar, eventKey: index, 
