 ...
 */
export interface ButtonToolbarControlSchema extends ButtonToolbarSchema, FormBaseControl {
    type: 'button-toolbar';
}
export interface ButtonToolbarProps extends FormControlProps, Omit<ButtonToolbarControlSchema, 'type' | 'className' | 'descriptionClassName' | 'inputClassName'> {
}
